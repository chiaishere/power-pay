    ...
    <body>
        ...
        >
            ...
            >
                ...
                >
                    <img src="/asset/image/powerpay.png" class="h-16" alt="" />
                    <span
        ...
        <div class="max-w-screen-xl mx-auto p-4 pt-32 py-10">
                ...
                <div class="flex items-center">
                    <div>
                        ...
                        <p class="text-lg font-normal text-gray-900 mb-4">
                            ...
                            listrik yang <br />
                            praktis dan aman bagi Anda. Dengan platform kami,
                            Anda dapat membayar tagihan listrik secara online
                            dengan cepat dan mudah, kapan saja dan di mana saja.
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <br />
                    <p class="text-lg font-normal text-gray-900 mb-4">
                        Bergabunglah dengan pengguna lain yang telah menikmati
                        kemudahan dalam membayar tagihan listrik bersama Power
                        Pay.
                    </p>
                </div>
            </div>
        ...
        >
            ...
            <div class="grid grid-cols-3 gap-5">
                <!-- card 1 -->
                <div class="flex gap-5 items-center w-[15px] p-2">
                    <!-- img -->
                    <img
